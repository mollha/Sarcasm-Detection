...
\footnotetext[2]{https://www.collinsdictionary.com/dictionary/english/irony}
...
\begin{enumerate}[leftmargin=0cm]
	\item \textbf{News Headlines} - \textit{Misra et al.\ (2019)} \cite{misra2019sarcasm} collected thousands of news headlines from two sources - \textit{The Onion} \footnotemark[4]\footnotetext[4]{www.theonion.com} (renowned for posting satiricial news) and \textit{The Huffington Post} \footnotemark[5]\footnotetext[5]{www.huffpost.com}. They utilised a hybrid neural network architecture and achieved a classification \textit{accuracy} of 0.897.\vspace{-5pt}
...
\end{minipage}\\
\footnotetext[6]{Figure obtained from https://nlp.stanford.edu/projects/glove/}
