...
\noindent We analyse the effectiveness of our novel sentiment features against that of our standard punctuation and topic modelling features by feeding them to a logistic regression model and calculating the $F_1$ score; logistic regression is used as these feature vectors are small. We use 5-fold cross-validation to compute the $F_1$ scores of these models. A classifier producing random predictions can achieve an $F_1$ score of 0.5 on a balanced dataset - hence, we consider models achieving greater than 0.5 to be indicative of useful training features.\vspace{-15pt}
...
\begin{minipage}{0.6\textwidth}
	\begin{minipage}{0.48\textwidth}
		\begin{center}
			...
			\hspace{-1cm}\textbf{(b)} Without Attention\\
		\end{center}
	\end{minipage}
	\begin{minipage}{0.48\textwidth}
		\begin{center}
			\hspace{-1cm}\includegraphics[width=0.9\textwidth]{Images/attention-lstm.png}\\
			\hspace{-1cm}\textbf{(a)} With Attention\\
		\end{center}
	\end{minipage}
	\begin{center}
		\hspace{-20pt}\textbf{Figure -:} Accuracy and \_ statistics of models during training\\
	\end{center}
\end{minipage}
\begin{minipage}{0.4\textwidth}
	example text
