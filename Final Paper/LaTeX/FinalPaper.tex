...
\noindent \textbf{2. Topic features --} We use topic modelling, where each instance in a dataset is represented as the distribution of its topics (relative to the topics in the global dataset).\\
...
\hspace{-15pt}\begin{minipage}{0.55\textwidth}
	Example: \textit{"i love when my train is late"}\vspace{-15pt}
	\begin{center}	
