...
\noindent \textbf{Method --} We gather three labelled datasets containing Twitter data, news headlines and Amazon reviews. This text is transformed into numerical vectors using multiple vectorisation techniques, including a state-of-the-art contextualised embedding approach (ElMo). 
