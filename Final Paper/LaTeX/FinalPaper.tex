...
\begin{minipage}{0.55\textwidth}
	...
	\begin{center}	
		\begin{tabular}{|m{2cm}||m{0.4cm}m{0.6cm}m{0.75cm}m{0.4cm}m{0.7cm}m{0.2cm}m{0.6cm}|}
			\hline 
		...
		\begin{tabular}{|p{2cm}||p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|} 
			\hline 
