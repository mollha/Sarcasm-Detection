...
Variations of the vanilla RNN such as \textit{Long Short-Term Memory (LSTM)} and \textit{Gated Recurrent Units (GRU)} use internal mechanisms, known as gates, which allow them to overcome the issue of short-term memory. We implement a Vanilla RNN as a baseline against which to compare our more advanced RNN models, providing a brief description of these below.
