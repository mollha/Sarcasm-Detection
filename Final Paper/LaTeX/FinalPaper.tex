...
\noindent The \textbf{minimum} objectives of this project are to evaluate and clean high-quality datasets, and to employ machine learning models in order to evaluate their performance on our chosen datasets. To fulfil these objectives we gather datasets with desirable qualities from multiple platforms and compute summary statistics in order to understand the versatility of how sarcasm is used online.


Of our machine learning classifiers, we found that our logistic regression model performed best for both datasets, achieving  $F_{1}$ scores of 0.851 and 0.790. The purpose of this objective was to establish a baseline against which to compare the performance of our deep learning classifiers.
