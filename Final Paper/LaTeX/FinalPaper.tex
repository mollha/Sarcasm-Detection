...
\begin{center}
	\begin{tabular}{p{4.3cm}p{2.1cm}p{2.6cm}p{2.2cm}p{1.8cm}}
		...
		\midrule\midrule
		News Headlines Dataset For Sarcasm Detection & \begin{tabular}{c@{}@{}@{}} \\28619\\[1ex] pos: 47.6\% \\[1ex] neg: 52.4\% \end{tabular} &  11.2 tokens & 97.8\% & 89.7\%\\[1ex]
		\midrule
		Sarcasm Amazon Review Corpus & \begin{tabular}{c@{}@{}@{}} \\1254\\[1ex] pos: 34.9\% \\[1ex] neg: 65.1\% \end{tabular} &  276.4 tokens & 98.2\% & N/A \\[1ex]
		\hline
	\end{tabular}\\
\end{center}
\vspace{2pt}
