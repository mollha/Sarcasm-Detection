...
\noindent \textbf{Method --} We first gather two labelled training datasets containing Twitter data and news headlines and a third evaluation dataset containing Amazon reviews.\ We contrast four main vectorisation approaches, including a state-of-the-art contextualised embedding approach (ElMo), in their ability to transform text into meaningful numerical vectors.

transform this text into numerical vectors using multiple vectorisation approaches, including a state-of-the-art contextualised embedding approach (ElMo).\ 


These vectors are used to train machine learning classifiers, including Support Vector Machines and logistic regression models, as well as deep convolutional and recurrent neural architectures.
