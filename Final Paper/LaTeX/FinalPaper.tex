...
\begin{center}
	\textbf{Figure 1}: Comparison of defintions of Irony and Sarcasm\vspace{-10pt}
\end{center}
\begin{center}
...
Each deep learning model is trained separately on each of the three datasets, using glove vectors and elmo vectors. Sparse feature representations such as tf-idf and bag of words are not used
...
\begin{enumerate}
	\item \textbf{Early stopping --} Training is interrupted when a chosen performance measure stops improving. We monitor the minimisation of the loss on the validation dataset as our chosen performance measure and use this to determine the appropriate number of epochs.
