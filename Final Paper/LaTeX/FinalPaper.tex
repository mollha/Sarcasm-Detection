...
\noindent \textbf{Aims --} The aim of this project is to extend the current state of the art in sarcasm detection by comparing the performance of traditional machine learning and sophisticated deep learning classifiers. Furthermore, we investigate to what extent manually extracted sentiment features can be used to enhance machine learning classification, contrasting their performance to more conventional handcrafted features. Lastly, we aim to extend our superior binary classification solution in order to highlight tokens that correlate more to sarcastic and non-sarcastic labels.\vspace{5pt}

\noindent \textbf{Method --} We first gather two labelled training datasets containing Twitter data and news headlines, as well as a third evaluation dataset containing Amazon reviews.\ We compare four main vectorisation methods, including a state-of-the-art contextualised embedding approach (ElMo), in their ability to transform text into meaningful numerical vectors. Moreover, we extract sentiment, topic and punctuation features to investigate their ability to enhance machine learning classifcation in combination with our main features. These vectors are used to train machine learning and deep learning classifiers to detect the presence of sarcasm. In addition, an attention mechanism is incorporated to localise the presence of sarcasm within a passage of text.\vspace{5pt}

including Support Vector Machines and logistic regression models, and deep learning classifiers such as deep convolutional and recurrent neural architectures.



 These vectors are used to train various machine learning and deep learning classifiers to detect the presence of sarcasm. In addition, an attention mechanism is incorporated to localise the presence of sarcasm within a passage of text.\vspace{5pt}
