...
\noindent Five classifiers are trained independently on each of our datasets, vectorised using Bag of Words, TF-IDF, GloVe and ElMo.\\ %The $F_{1}$ scores of the trained models are provided to 3 significant figures, and the scores of the best-performing models are highlighted for each dataset, paired with each vectorisation approach.\\
...
Interestingly, the Random Forest Classifier was the best performing model using GloVe vectors.
...
\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|c|}
		...
		\hline\hline
		CNN   & 0.823 & 0.827 & 0.801 & 0.861& 0.863& 0.832 \\
		Deep CNN   & 0.829 & 0.836 & 0.811 & 0.861& 0.868& 0.841 \\
		LSTM & 0.840 & 0.838 & \textbf{0.841} & 0.860& 0.857& 0.839 \\
		Bi-directional LSTM & \textbf{0.864} & 0.853 & 0.822 & 0.874& 0.872& 0.849 \\
		Vanilla RNN & 0.817 & 0.803 & 0.785 & 0.855& 0.812& 0.817 \\
		Vanilla GRU &0.852 & 0.844 & 0.812 & \textbf{0.883} & 0.853& 0.823 \\
		\hline
	\end{tabular}
\end{center}
