...
\noindent However, there was an increase in training time, and the rate of increase of the validation accuracy decreased. Figure \_ shows the fluctuation in training and validation accuracy whilst training our bidirectional LSTM models, with and without our attention mechanism.\\ 	 Incorporating our attention mechanism led to a slower training process as the number of training epochs increased from 12 to 16. Furthermore, the validation accuracy of our attention model increased at a steadier pace and peaked at a slightly lower value.\\
