...
\end{center}
\vspace{-7pt}
*\textit{pos} indicates positive instances and \textit{neg} indicates negative instances.\\
\vspace{2pt}
...
\begin{center}
\textbf{Figure -}:  Proportion of tokens in the GloVe dictionary before and after cleaning\\
\vspace{4pt}
\begin{tabular}{p{3cm}||p{3cm}p{3cm}}
	\toprule
	\hline
	&\multicolumn{2}{c}{\textbf{Proportion in GloVe dictionary}} \\
	\hline
	\textbf{Dataset} & \textbf{Original data} & \textbf{Processed data}\\
	\hline
	News Headlines & \hspace{20pt}97.8\% & \hspace{20pt}\_\%\\
	\hline
	Amazon Reviews & \hspace{20pt}98.2\% & \hspace{20pt}\_\%\\
	\hline
	Twitter Data & \hspace{20pt}73.9\% & \hspace{20pt}\_\%\\
	\hline
\end{tabular}\\
\end{center}
