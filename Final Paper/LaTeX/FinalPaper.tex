...
Transforming text into lowercase is useful for reducing sparsity caused by variations in letter capatilisation e.g. 'not', 'NOT', and 'Not' are all mapped to the same word - 'not'. 


Similarly, removing punctuation and extending contractions (e.g. don't $\rightarrow$ do not) is commonplace. However, punctuation and capitalisation can be used for emphasis, therefore removing these attributes may make the presence of sarcasm less obvious.
...
- replace \#sarcasm in the twitter dataset for sarcastic instances
- remove punctuation
- remove numbers
- remove stopwords\\
