...
\hspace{-17pt}\begin{minipage}{0.6\textwidth}
	 Finally, the output sequences are passed through our attention layer, which returns a context vector and attention weights. We can visualise our attention weights by projecting them into a colourspace and displaying the tokens highlighted in their respective colours, where darker colours indicate a higher-level of attention.\\
\end{minipage}
\hspace{0pt}
