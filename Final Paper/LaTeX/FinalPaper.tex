...
\begin{figure}[H]
	\begin{center}
		...
		\textbf{Figure 7:} Word-level Attention \cite{yang2016hierarchical}\\
	\end{center}
\end{figure}
\end{minipage}

\noindent Our attention layer returns the attention weight, $a_{it}$ for each token, as well as the sentence-level content vector, $s_i$, which is propagated through the remainder of our classifier.\\





We take the dot product of the alignment scores and the hidden states
...
\paragraph{might use this in the related work section}
