...
\noindent \textbf{Results --} Our solution consists of a bidirectional LSTM with an intermediate attention layer. While this was not our highest-achieving model, this was most able to generalise to unseen data, achieving an $F_1$ score of 0.862. 

Our bidirectional GRU trained on twitter data achieved the highest $F_1$ score of 0.862, although it was less able to generalise to unseen data than our bidirectional LSTM model trained on the Twitter dataset. We integrated our attention mechanism into this bidirectional LSTM model, improving upon our previous $F_1$ score by 1.5\% and achieving an $F_1$ of 0.862.\vspace{5pt}
