...
\subsection{Comparison of Machine Learning and Deep Learning Classification}
...
\begin{center}
	\begin{tabular}{ |c||c|c|c|c|}
		\hline
		\textbf{Model Architechture}& \textbf{Feature(s)*} & \textbf{Precision} & \textbf{Recall} & \textbf{$\mathbf{F_1}$ Score}\\
		\hline\hline
...
\begin{tabular}{|c||c|c|c||c|c|c|}
	...
	\cline{1-7}
	& Recall & Precision & $F_1$ & News & Amazon & Twitter\\
	\cline{1-7}
