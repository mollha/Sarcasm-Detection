...
\indent \textbf{Aims --} Despite the challenges in this domain, this project ultimately aims to produce a tool that can detect sarcasm with a \textit{high degree} of accuracy. 
...
\indent \textit{- Does incorporating sentiment features improve the solution?}\\ 
