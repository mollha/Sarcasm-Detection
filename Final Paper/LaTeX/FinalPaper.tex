...
\begin{center}
	...
	\begin{tabular}{p{4.3cm}p{2.1cm}p{2.6cm}p{2.2cm}p{1.8cm}}
		...
		Sarcasm Amazon Review Corpus & \begin{tabular}{c@{}@{}@{}} 1254\\ pos: 34.9\% \\ neg: 65.1\% \end{tabular} &  \hspace{15pt}276.4 & 98.2\% & N/A \\
			\midrule
		Pt\'a\v{c}ek et al. (2014)& \begin{tabular}{c@{}@{}@{}} 1254\\ pos: 34.9\% \\ neg: 65.1\% \end{tabular} &  \hspace{15pt}276.4 & 98.2\% & 0.947 \\
		\hline
	\end{tabular}\\
\end{center}
\vspace{2pt}
...
\subsubsection{Experimentation with sentiment features}
