...
\noindent \textbf{Aims --} The aim of this project is to extend the current state of the art in sarcasm detection by investigating the use of traditional machine learning and sophisticated deep learning classifiers. Furthermore, we investigate to what extent manually extracted sentiment features can be used to enhance machine learning classification, contrasting their performance to more conventional handcrafted features. Lastly, we aim to extend our superior binary classification solution in order to highlight tokens that correlate more to sarcastic and non-sarcastic labels.\vspace{5pt}

\noindent \textbf{Method --} We first gather two labelled training datasets containing Twitter data and news headlines, as well as a third evaluation dataset containing Amazon reviews.\ We compare both established and experimental vectorisation methods, including a state-of-the-art contextualised embedding approach (ElMo), in their ability to transform text into meaningful numerical vectors. These vectors are used to train machine learning and deep learning classifiers to detect the presence of sarcasm, and an attention mechanism is incorporated into our superior binary classification solution to localise the presence of sarcasm.\vspace{5pt}

\noindent \textbf{Results --} 


We show that deep learning models vastly outperform machine learning models in the sarcasm detection.\vspace{5pt}
