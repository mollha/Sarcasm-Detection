...
It poses a significant challenge to classic sentiment anaylsers, which deduce the sentiment polarity of text based-upon surface-level features such as the number of positive or negative influences in a sentence. 
