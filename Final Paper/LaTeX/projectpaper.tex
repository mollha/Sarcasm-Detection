...
\begin{abstract}
\\ \indent \textbf{Context / Background --} this is bold

\indent \textbf{Aims --} this is bold

\indent \textbf{Method --} this is bold

\indent \textbf{Results --} this is bold

\indent \textbf{Conclusions --} this is bold

This section should not be longer than half of a page, and having no more than one or two sentences under each heading is advised. These instructions give you guidelines for preparing the final paper.  DO NOT change any settings, such as margins and font sizes.  Just use this as a template and modify the contents into your final paper.  Do not cite references in the abstract.
\end{abstract}
