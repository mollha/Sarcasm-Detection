...
\subsection{Terms}
\noindent \textbf{Irony} \cite{cambridge22019}: The use of words that are the opposite of what you mean, as a way of being funny.\\
\textbf{Sarcasm} \cite{cambridge2019}: The use of remarks that clearly mean the opposite of what they say, made in order to hurt someone's feelings or to criticize something in a humorous way.\\
