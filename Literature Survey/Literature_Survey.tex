...
Deep neural networkss are increasingly being used in text classification tasks \cite{zhang2015character, poria2016deeper, }. Two common architectures used in text classification are Convolutional Neural Networks and Recurrent Neural Networks.

Poria et al. (2017) describes a convolutional neural network (CNN) for sarcasm detection. Convolutional neural networks are 
 ...
 Recurrent neural networks are used on time-series data
